...
public class Main {
  ...
  public static void main(String[] args) {
     ...
     * 
     * boolean isLoop = true; if(input.equalsIgnoreCase("4")) { isLoop = false; }
     * 
     * 
     * while(isLoop) {
     * 
     * showOperation(); input = sc.nextLine();
     * 
     * switch(input) { case "1": System.out.println("一覧表示"); show(); break;
     * 
     * case "2": System.out.println("新規作成"); break;
     * 
     * case "3": System.out.println("削除"); break;
     * 
     * default: System.out.println("アプリを終了します\n"); isLoop = false; break; }
     * 
     * 
     * System.out.println("\n"); }
     * 
